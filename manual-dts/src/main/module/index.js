...
class $c_LTutorialApp$ extends $c_O {
  greet__V() {
    const this$2 = $m_s_Console$();
    const this$3 = this$2.out__Ljava_io_PrintStream();
    this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Greetings\n")
  };
}
const $d_LTutorialApp$ = new $TypeData().initClass({
  LTutorialApp$: 0
}, false, "TutorialApp$", {
  LTutorialApp$: 1,
  O: 1
...
let $n_LTutorialApp$ = (void 0);
function $m_LTutorialApp$() {
  if ((!$n_LTutorialApp$)) {
    $n_LTutorialApp$ = new $c_LTutorialApp$()
  };
...
$L0 = new $c_RTLong(0, 0);
let $e_greet = (function() {
  $m_LTutorialApp$().greet__V()
});
export { $e_greet as greet };
//# sourceMappingURL=manual-dts-fastopt.js.map
